package Java_Study;
    ...
    public class Load_Java {
         ...
         * 实例化完成
         */
        public static Load_Java t1 = new Load_Java("t1");
        /**第三个加载 过程同上
         * 首先初始化j 打印出  4:j i=3 n=3
         * 执行构造块     打印出  5:构造快 i=4 n=4
         * 执行构造方法 打印出  6:t2 i=5 n=5
         */
        public static Load_Java t2 = new Load_Java("t2");
        /**第四个加载
         * 打印出  7:i i=6 n=6
         */
        ...
        public static void main(String[] args) {
             ...
             *         此时实例化完毕
             */
            Load_Java t = new Load_Java("init");
        }
